...
export default function Hero() {
  ...
  return (
    <>
      <section className={`${style.HeroSection} relative left-[0px] bg-[#031f0c] h-[100vh] text-center rounded-b-[8px] `}>
        <div className={`${style.container} absolute inset-0 flex flex-nowrap flex-col justify-center`}>
          ...
          <div className="absolute top-[20%] left-[-30%] w-[80rem] h-[12em]
           ...
           blur-[990px] opacity-50 rotate-[35deg] z-0 pointer-events-none">
          </div>
          {/* Title */}
          <h1 className={`text-[40px] md:text-6xl dark:text-white m-6 mb-15 animate__animated animate__fadeIn `}>
            Welcome to <br /> <span id={style.FreshSpan}>FreshCart

              <svg id={style.FreshSvg} className="" xmlns="http://www.w3.org/2000/svg" width="236" height="28" viewBox="0 0 236 28" fill="none">
          ...
          {/* Paragraph */}
          <p className={`dark:text-neutral-200 text-[12px] md:text-[1em] sm:text-[0.9em] me-auto ms-auto w-[65%] animate__animated animate__fadeIn  mb-7`}>
        ...
        <ContainerScroll className={``} >
          ...
          <img src={img1} className={style.BannerImg} alt="" />
