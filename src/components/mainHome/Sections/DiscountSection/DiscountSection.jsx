...
export default function DiscountSection() {
    return <>
        <section className={`${style.DiscountSection} rounded-[7px] overflow-hidden mb-10`}>
            <div className={`${style.container} relative`}>

                <div className="grid grid-cols-2 lg:grid-cols-12  h-[100%] ">
                    <div className={`${style.sectionColumn1} col-span-6 pe-2  lg:mx-auto`}>
                        <img src={img} className='w-140' alt="" />
                    </div>


                    <div className={`${style.sectionColumn2} col-span-6 pt-22 lg:ps-5 flex justify-start flex-col flex-nowrap `} >
